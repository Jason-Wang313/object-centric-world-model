...
Our contribution is a compact controlled study: an exact finite selection law, object-centric synthetic environments, a learned CPU artifact, repair selectors, and an audit that keeps unsupported claims unsupported.
