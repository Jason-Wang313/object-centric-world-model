...
This project is not a diffusion world-model benchmark. Diffusion-style world models can generate rich future samples, but this repo studies finite selection laws and object-level repair signals in controlled CPU scenes.

This project is not a real-robot paper. It is a controlled synthetic v1 intended to make the failure mode, law, and repair hypotheses precise enough to test before broader benchmarks.
