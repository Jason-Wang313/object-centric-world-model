...
- Identity consistency, hidden-property calibration, targeted probing, and combined repair improve selected utility in the controlled synthetic setting, including paired seed gains, bootstrap confidence checks, repair ablations, seed-block robustness, score-noise sensitivity, dense-object OOD stress, toy model-family proxy diagnostics, and a high-N stress panel.
